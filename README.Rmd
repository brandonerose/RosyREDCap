...
Use your REDCap API tokens to create an updating R list object (DB) which can used downstream for analysis, data exports, shiny apps, and even data imports! We are still in development. At this time this package is **not suited for Multi-Arm projects or massive REDCap projects yet**.  More to come in future versions! 

Minimum Requirements
* R (and ideally RStudio) installed on your computer
* Access to at least one REDCap projects (real or test) with API Token Privileges according to User Rights
